...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/downloads_path_provider/downloads_path_provider.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/geocoder/geocoder.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/otp_autofill/otp_autofill.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/sim_info/sim_info.framework"
